...
class ProductForm extends Component {
  ...
  componentWillReceiveProps(nextProps) {
	...
	handleFormSubmit(props) {
		...
		if(this.state.productData.availablity) {
			props['availablity'] = this.state.productData.availablity;
		}
		...
		return (
		  <div className="product-form wrapper">
		      ...
		      <Field
		        ...
		        component={renderInputField}
		        label="Sizes"
		        setValue={this.state.productData.sizes}
		        onValueChange={(e) => this.handleInputChange(e)}
		      />
		      <Field
		        name="originalPrice"
		        ...
		        setValue={this.state.productData.originalPrice}
		        onValueChange={(e) => this.handleInputChange(e)}
		      />
		      <Field
		        name="customerPrice"
		        ...
		        setValue={this.state.productData.customerPrice}
		        onValueChange={(e) => this.handleInputChange(e)}
		      />
		      <Field
		        name="availablity"
		        component={renderSelectField}
		        label="Availability"
		        optionList={this.getAvailablity()}
		        setValue={this.state.productData.availablity}
		        onValueChange={(e) => this.handleInputChange(e, 'availablity')}
		        // validate={[required]}
		      />
		      <Field
	        ...
	        />
		      <div>
		        ...
		        <div className="admin-dashboard-link">
		          Back to <Link to="/admin/products">Products</Link>
		        </div>
		      </div>
