...
import { renderInputField, renderFileInputField, renderTextAreaField } from '../../_components';
...
class UserForm extends Component {
  ...
  componentWillReceiveProps(nextProps) {
  	if(nextProps.userData && this.props.match.params.userId) {
		...
		return (
			<div className="register-form">
		      ...
		      <Field
		        ...
		        label="Address"
		        onValueChange={(e) => this.handleInputChange(e)}
		        setValue={this.state.userData.address}
		        validate={this.state.userData.address ? null : [required]}
		      />
		      <Field
		        name="email"
		        type="text"
