...
export const addProductToCart = function(productId, userId, productSize) {
  return (dispatch) => {
    productService.addProductToCart(productId, userId, productSize)
      .then(
        user => {
          dispatch({ 
            type: FETCH_USER,
...
export const removeProductFromCart = function(productId, userId) {
  return (dispatch) => {
